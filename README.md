...
- **34,166 native recipes**, represented by **40,089 machine-tier variants**, with searchable ingredients, machine selection and runtime textures. This includes **8,070 macerator recipes**, **245 Electric Blast Furnace recipes** (both Kanthal routes), **960 Greenhouse, vacuum freezer, LCR and implosion compressor recipes**, and **36 generator fuel recipes**.
